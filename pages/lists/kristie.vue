...
<template>
  <div class="list--wrapper">
    ...
    <Navigation class="anim--fade-in gravity">
      ...
      <template v-slot:right>Kristie</template>
    </Navigation>
    ...
    <header id="fixed" class="pt-9">
      ...
      <img ref='avatar' class="avatar" src="~/static/img/avatars/kristie.jpg" alt="kristie">
    </header>
    ...
    <n-link to = '/2019'>
      <footer class="tac respira link">View All Lists</footer>
    </n-link>
...
<script>
  ...
  export default {
    head() { return { title: "AOTY – Kristie's List" }},
